...
aut aut aut maxime quia temporibus ut omnis`}],Lc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],tm=({user:e})=>$.jsxs("p",{children:[" Posted by  ",$.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name})]}),Tc=({comment:e})=>$.jsxs("div",{className:"CommentInfo",children:[$.jsx("p",{className:"CommentInfo__text",children:e.body}),$.jsx("p",{className:"CommentInfo__email",children:e.email}),$.jsx("p",{className:"CommentInfo__name",children:e.name}),"`",e.user&&$.jsx(tm,{user:e.user}),"`"]}),Mc=({comments:e})=>$.jsx("div",{className:"CommentList",children:e&&e.length>0?e.map(t=>$.jsx(Tc,{comment:t},t.id)):$.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})}),Rc=({post:e})=>$.jsxs("article",{className:"PostInfo",children:[$.jsx("h2",{className:"PostInfo__title",children:e.title}),$.jsx("p",{className:"PostInfo__body",children:e.body}),$.jsx(tm,{user:e.user}),e.comments&&e.comments.length>0&&$.jsx(Mc,{comments:e.comments})]}),Dc=({posts:e})=>$.jsx("div",{className:"PostList",children:e.map(t=>$.jsx(Rc,{post:t}))});function im(e){return Lc.find(t=>t.id===e)||null}function jc(e){return Pc.filter(t=>t.postId===e).map(t=>({...t,user:im(t.userId)}))}const Oc=Nc.map(e=>({...e,comments:jc(e.id),user:im(e.userId)})),Fc=()=>$.jsxs("section",{className:"App",children:[$.jsx("h1",{className:"App__title",children:"Static list of posts"}),$.jsx(Dc,{posts:Oc})]});em(document.getElementById("root")).render($.jsx(Fc,{}));
